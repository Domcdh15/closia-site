(function () {
  ...
  root.innerHTML = `
    <button id="cw-toggle" aria-label="Assistant Clos-ia" class="cw-toggle">
    ...
    <div id="cw-panel" class="cw-panel" hidden>
      <div class="cw-header">
        <span>Assistant Clos-ia</span>
        <button id="cw-close" aria-label="Fermer" class="cw-close">&times;</button>
      </div>
      <div id="cw-messages" class="cw-messages">
        <div class="cw-msg cw-msg-assistant">Bonjour ! Une question sur Clos-ia (fonctionnalités, tarifs, démo) ? Je suis là pour vous aider.</div>
      </div>
